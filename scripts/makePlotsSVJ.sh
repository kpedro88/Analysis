...
CMDS=(
	...
	'KPlotDriver.C+(".",{"input/input_svj_rocs_hist_'${SEL}'.txt","input/input_svj_rocs.txt","input/input_svj_rocs_bothjet_E1a.txt","'${SIG}'","input/input_svj_rocs_ext_bkg.txt","input/input_svj_flatten_bothjet.txt"},{"OPTION","vs+:printformat[pdf]"},1)' \
	'KPlotDriver.C+(".",{"input/input_svj_rocs_hist_'${SEL}'.txt","input/input_svj_rocs.txt","input/input_svj_rocs_bothjet_E1b.txt","'${SIG}'","input/input_svj_rocs_ext_bkg.txt","input/input_svj_flatten_bothjet.txt"},{"OPTION","vs+:printformat[pdf]"},1)' \
	'KPlotDriver.C+(".",{"input/input_svj_rocs_hist_'${SEL}'.txt","input/input_svj_rocs.txt","input/input_svj_rocs_bothjet_E1c.txt","'${SIG}'","input/input_svj_rocs_ext_bkg.txt","input/input_svj_flatten_bothjet.txt"},{"OPTION","vs+:printformat[pdf]"},1)' \
)
