...
PrivateSamples.SVJ_mZprime-3000_mDark-20_rinv-0p3_alpha-0p1_n-500_0_RA2AnalysisTree.root \
)
DIRS=(
...
root://cmseos.fnal.gov//store/user/lpcsusyhad/SVJ2017/ProductionV1/Ntuples \
)
TREES=(
