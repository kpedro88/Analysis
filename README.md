...
```
cd batch
./DCsub_svj.sh -t SVJData,SVJBkg -y Run2 -v trig8/sigfull
(wait for jobs to finish)
../finalizeDatacardsSVJ.sh -d /store/user/pedrok/SVJ2017/Datacards/trig8/sigfull -k
./DCsub_svj.sh -t SVJScan -y Run2 -v trig8/sigfull
```

Signal systematics studies:
```
cd batch
./HSsub.sh -c block,scan -d /store/user/pedrok/SVJ2017/Datacards/trig8/sigfull -S scan -k -n 1
cd ..
python summarizeSyst.py -d /store/user/pedrok/SVJ2017/Datacards/trig8/sigfull -c "mDark==20.&&rinv==0.3&&alpha==-2."
```
