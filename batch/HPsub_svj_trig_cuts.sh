...
for YEAR in 2016 2017; do
	...
	INPUTS='"input/input_svj_hist_data_'${YEAR}'.txt","input/input_svj_trig'${YEAR}'_cuts.txt","input/input_svj_trig_hist.txt"'
	...
	for PERIOD in ${PERIODS[@]}; do
		...
		JOBNAME="hist_trig_cuts_"${YEAR}${PERIOD}
