...
root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/$RUN2PRODV \
root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/$RUN2PRODV \
root://hepxrd01.colorado.edu:1094//store/user/aperloff/SusyRA2Analysis2015/Skims/$RUN2PRODV/tree_signal \
root://cmseos.fnal.gov//store/user/lpcsusyhad/SVJ2017/$RUN2PRODV/Skims/tree_dijetmtdetahadloose \
)
TREES=(
