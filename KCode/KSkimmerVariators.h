...
class KJetVariator : public KVariator<KSkimmer> {
	public:
		...
		//member variables
		bool enabled;
		bool b_Jets,b_HTJetsMask,b_MHTJetsMask,b_ISRJetsMask,b_Jets_ID,b_Jets_partonFlavor,b_Jets_hadronFlavor,b_Jets_bDiscriminatorCSV,b_Jets_bDiscriminatorMVA;
		vartypes vtype;
