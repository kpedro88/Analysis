...
def makeSkimInput(read,write):
    ...
    for rline in rfile:
        ...
        wline = "base" + "\t" + "skim" + "\t" + short_name + "\t" + "b:chain[1]" + "\t" + "s:filepre[" + full_name + "_]" + "\t" + "vi:filerange[0," + str(len(readFilesImport)-1) + "]" + "\t" + "s:filesuff[_RA2AnalysisTree.root]" + "\t" + "s:chainsuff[/TreeMaker2/PreSelection]" + "\n"
        wfile.write(wline)
        tot += len(readFilesImport)

        #todo: add optional mother particle id processing
    print "njobs: " + str(tot)
